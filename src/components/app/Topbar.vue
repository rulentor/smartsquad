...
<!-- eslint-disable -->
	...
	<!--Menu v-if="topbarmenu_open" id="overlay_menu" ref="menu" :model="menuItems" :popup="true" /-->
        ...
        <ul class="layout-topbar-menu lg:flex origin-top">
            <li>
               <span style="font-size: 1.2rem; margin-left:1rem">Портал</span>
            </li>
        </ul>			
...
const user_ = null //getCookie('userState')
const menu = ref()
...
const toggle = (event: PointerEvent) => {
  //menu.value.toggle(event)
	...
	console.log('style',menuprofile.value)
	//console.log('user-menu-toggle',event,menuprofile.value)
}
/*
